...
let rec _menhir_run7 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.typs) -> 'ttv_return =
...
and _menhir_goto_args : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.args) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState29 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (_1 : (Ast.arg))), _, (_3 : (Ast.args))) = _menhir_stack in
        let _v : (Ast.args) = 
# 88 "parser.mly"
                        (ASTArgs(_1,_3))
# 193 "parser.ml"
...
and _menhir_reduce24 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.typ) -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
...
# 233 "parser.ml"
    ...
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState60 | MenhirState51 | MenhirState16 | MenhirState7 | MenhirState3 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_run10 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.typ) -> _menhir_state -> 'ttv_return =
...
and _menhir_goto_cmds : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.cmds) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState65 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (_1 : (Ast.def))), _, (_3 : (Ast.cmds))) = _menhir_stack in
        let _v : (Ast.cmds) = 
# 55 "parser.mly"
                        (ASTDef(_1, _3))
# 297 "parser.ml"
    ...
    | MenhirState1 ->
        ...
        | RBRA ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _, (_2 : (Ast.cmds))) = _menhir_stack in
            let _v : (Ast.cmds) = 
# 50 "parser.mly"
                        ( _2 )
# 312 "parser.ml"
...
and _menhir_goto_def : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.def) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
and _menhir_goto_exprs : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.exprs) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState43 ->
        ...
        | RPAR ->
            ...
            let _menhir_env = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((_menhir_stack, _menhir_s), _, (_2 : (Ast.expr))), _, (_3 : (Ast.exprs))) = _menhir_stack in
            let _v : (Ast.expr) = 
# 95 "parser.mly"
                        ( ASTApp(_2, _3) )
# 375 "parser.ml"
    ...
    | MenhirState46 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (_1 : (Ast.expr))), _, (_2 : (Ast.exprs))) = _menhir_stack in
        let _v : (Ast.exprs) = 
# 105 "parser.mly"
             (ASTExprs(_1,_2))
# 391 "parser.ml"
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState7 ->
        ...
        | ARROW | COMA | IDENT _ | LBRA | LPAR | NUM _ | RBRA ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _menhir_s, (_1 : (Ast.typs))), _, (_3 : (Ast.typ))) = _menhir_stack in
            let _v : (Ast.typ) = 
# 75 "parser.mly"
                      (ASTTypeFunc(_1, _3))
# 414 "parser.ml"
...
# 479 "parser.ml"
            ...
            | RBRA ->
                let _menhir_stack = Obj.magic _menhir_stack in
                let (_menhir_stack, _menhir_s, (_1 : (Ast.arg))) = _menhir_stack in
                let _v : (Ast.args) = 
# 87 "parser.mly"
                        (ASTArg2(_1))
# 503 "parser.ml"
...
and _menhir_goto_expr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState25 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (((_menhir_stack, _menhir_s), _, (_2 : (Ast.args))), _, (_4 : (Ast.expr))) = _menhir_stack in
        let _v : (Ast.expr) = 
# 99 "parser.mly"
                          (ASTExprArgs(_2,_4))
# 607 "parser.ml"
...
# 17 "parser.mly"
       (string)
# 793 "parser.ml"
        ))), _, (_3 : (Ast.typ))), _), _, (_5 : (Ast.args))), _, (_7 : (Ast.expr))) = _menhir_stack in
        let _v : (Ast.def) = 
# 64 "parser.mly"
                                     (ASTFunc(_2, _3 ,_5, _7))
# 798 "parser.ml"
...
# 17 "parser.mly"
       (string)
# 807 "parser.ml"
        ))), _, (_4 : (Ast.typ))), _), _, (_6 : (Ast.args))), _, (_8 : (Ast.expr))) = _menhir_stack in
        let _v : (Ast.def) = 
# 65 "parser.mly"
...
# 17 "parser.mly"
       (string)
# 839 "parser.ml"
        ))), _, (_3 : (Ast.typ))), _, (_4 : (Ast.expr))) = _menhir_stack in
        let _v : (Ast.def) = 
# 63 "parser.mly"
                          (ASTConst(_2, _3, _4))
# 844 "parser.ml"
...
and _menhir_goto_typeBoolInt : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.typeBoolInt) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let (_1 : (Ast.typeBoolInt)) = _v in
    let _v : (Ast.typ) = 
# 74 "parser.mly"
                      ( Type(_1) )
# 858 "parser.ml"
...
# 994 "parser.ml"
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
    let _v : (Ast.typeBoolInt) = 
# 70 "parser.mly"
              (Bool)
# 1002 "parser.ml"
     in
    _menhir_goto_typeBoolInt _menhir_env _menhir_stack _menhir_s _v
...
and prog : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Ast.cmds) =
  fun lexer lexbuf ->
    let _menhir_env = {
      _menhir_lexer = lexer;
      _menhir_lexbuf = lexbuf;
    ...
    | LBRA ->
        ...
        (match _tok with
        | CONST ->
            _menhir_run59 _menhir_env (Obj.magic _menhir_stack) MenhirState1
        | ECHO ->
